...
def migrate_groups(origin, dest, groups, aws_key, aws_secret):
    from_conn = boto.ec2.connect_to_region(origin, aws_access_key_id=aws_key,
                                           aws_secret_access_key=aws_secret)
    to_conn = boto.ec2.connect_to_region(dest, aws_access_key_id=aws_key,
                                         aws_secret_access_key=aws_secret)
...
if __name__ == '__main__':
    ...
    migrate_groups(origin=from_region, dest=to_region, groups=groups, aws_key=AWS_KEY,
